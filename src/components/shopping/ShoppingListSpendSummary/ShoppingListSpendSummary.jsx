...
/**
 * Banner compacto de estimativa de gasto (lista autenticada ou compartilhada).
 */
export default function ShoppingListSpendEstimate({
  spendEstimate,
  pendingCount = 0,
}) {
...
/**
 * Cadastro rápido de preço unitário para itens sem média.
 */
export function ShoppingListSpendMissingPrices({
  spendEstimate,
  busyProductId = null,
  onSaveUnitPrices,
}) {
  ...
  if (!unpricedItems.length) return null;
